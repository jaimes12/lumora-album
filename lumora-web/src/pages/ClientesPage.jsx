...
const CLIENTES = [
  {
    id: 1,
    nombre: 'Fernanda García Reyes',
    email: 'fernanda.garcia@gmail.com',
    telefono: '+52 55 1234 5678',
    empresa: 'Familia García',
    etapa: 'client',
    ultimoContacto: 'Hace 2 días',
    eventos: 2,
    totalFacturado: '$152,500',
    notas: 'Clienta recurrente. Boda en junio y XV años de su sobrina en octubre.',
  },
  {
    id: 2,
    nombre: 'Carlos Mendoza Ortiz',
    email: 'c.mendoza@telmex.com',
    telefono: '+52 55 9876 5432',
    empresa: 'Telmex S.A. de C.V.',
    etapa: 'vip',
    ultimoContacto: 'Hoy',
    eventos: 5,
    totalFacturado: '$480,000',
    notas: 'Cuenta corporativa con eventos trimestrales. Requiere factura electrónica.',
  },
  {
    id: 3,
    nombre: 'Ana López Guzmán',
    email: 'ana.lopez@hotmail.com',
    telefono: '+52 81 2345 6789',
    empresa: 'Familia López',
    etapa: 'client',
    ultimoContacto: 'Hace 5 días',
    eventos: 1,
    totalFacturado: '$67,500',
    notas: 'XV años de Sofía para junio. Muy atenta a los detalles de decoración.',
  },
  {
    id: 4,
    nombre: 'Roberto Sánchez Peña',
    email: 'rsanchez@itesm.mx',
    telefono: '+52 81 8765 4321',
    empresa: 'ITESM Campus MTY',
    etapa: 'prospect',
    ultimoContacto: 'Hace 1 semana',
    eventos: 0,
    totalFacturado: '$0',
    notas: 'Interesado en evento de graduación. Pendiente de cotización aprobada.',
  },
  {
    id: 5,
    nombre: 'Mónica Reyes Castillo',
    email: 'monica.reyes@yahoo.com',
    telefono: '+52 33 3456 7890',
    empresa: 'Familia Reyes',
    etapa: 'client',
    ultimoContacto: 'Hace 3 días',
    eventos: 1,
    totalFacturado: '$18,500',
    notas: 'Bautizo de Sebastián en julio. Quiere paquete básico con fotografía.',
  },
  {
    id: 6,
    nombre: 'Héctor Villanueva Cruz',
    email: 'hvillanueva@grupoalfa.com.mx',
    telefono: '+52 55 7654 3210',
    empresa: 'Grupo Alfa Industrial',
    etapa: 'lead',
    ultimoContacto: 'Hace 2 semanas',
    eventos: 0,
    totalFacturado: '$0',
    notas: 'Evento cancelado por restructura interna. Mantener contacto para Q4.',
  },
  {
    id: 7,
    nombre: 'Valeria Torres Mondragón',
    email: 'valeria.torres@gmail.com',
    telefono: '+52 55 5432 1098',
    empresa: 'Familia Torres',
    etapa: 'prospect',
    ultimoContacto: 'Ayer',
    eventos: 0,
    totalFacturado: '$0',
    notas: 'Boda para julio. Cotización en proceso. Muy interesada en decoración floral.',
  },
  {
    id: 8,
    nombre: 'Diego Ramírez Flores',
    email: 'diego.ramirez@innovatech.mx',
    telefono: '+52 55 2109 8765',
    empresa: 'InnovaTech México',
    etapa: 'lead',
    ultimoContacto: 'Hace 3 días',
    eventos: 0,
    totalFacturado: '$0',
    notas: 'Startup. Busca evento de lanzamiento de producto para agosto.',
  },
]
              ...
              {filtered.map(c => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className={styles.muted}>{c.ultimoContacto}</td>
                  </tr>
                )
              })}
            </tbody>
            ...
            <div className={styles.drawerBody}>
              <div className={styles.infoGrid}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.infoValue}>{selected.ultimoContacto}</span>
                </div>
              </div>
